...
type MediaServiceClient interface {
	...
	ChangeMemberState(ctx context.Context, in *SpaceUserRequest, opts ...grpc.CallOption) (*Void, error)
}
...
func (c *mediaServiceClient) ChangeMemberState(ctx context.Context, in *SpaceUserRequest, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
...
type MediaServiceServer interface {
	...
	ChangeMemberState(context.Context, *SpaceUserRequest) (*Void, error)
...
func (UnimplementedMediaServiceServer) ChangeMemberState(context.Context, *SpaceUserRequest) (*Void, error) {
...
func _MediaService_ChangeMemberState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediaServiceServer).ChangeMemberState(ctx, req.(*SpaceUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
